...
RSpec.describe AdvertisementsController, type: :controller do
  let(:my_advertisement) { Advertisement.create!(title: 'My Ad Title', body: 'My Ad Body', price: 6) }
  ...
  describe 'POST create' do
    it 'increases the number of Advertisement by 1' do
      expect { post :create, advertisement: { title: 'My Ad Title', body: 'My Ad Body', price: 6 } }.to change(Advertisement, :count).by(1)
    end

    it 'assigns the new advertisement to @advertisement' do
      post :create, advertisement: { title: 'My Ad Title', body: 'My Ad Body', price: 6 }
